...
mod tests {
    ...
    fn test05() {
        ...
        assert_eq!(computer.insert(7).unwrap().run().unwrap().pop().unwrap(), 1);
        let mut computer = Computer::new(input).unwrap();
        assert_eq!(computer.insert(9).unwrap().run().unwrap().pop().unwrap(), 0);
        let input =
            "3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99"
                .to_owned();
        let mut computer = Computer::new(input.clone()).unwrap();
        assert_eq!(
            computer.insert(7).unwrap().run().unwrap().pop().unwrap(),
            999
        );
        let mut computer = Computer::new(input.clone()).unwrap();
        assert_eq!(
            computer.insert(8).unwrap().run().unwrap().pop().unwrap(),
            1000
        );
        let mut computer = Computer::new(input).unwrap();
        assert_eq!(
            computer.insert(9).unwrap().run().unwrap().pop().unwrap(),
            1001
        );
